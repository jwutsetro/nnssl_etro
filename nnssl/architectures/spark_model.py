...
from nnssl.architectures.spark_utils import SparseInstanceNorm3d, SparseSyncBatchNorm3d, _cur_active, _get_active_ex_or_ii
...
class SparK3D(nn.Module):
    ...
    def __init__(
        ...
        for i, feats_per_stage in enumerate(
            features_per_stage
        ):
