...
def evaluate_folder_entry_point():
    ...
    parser.add_argument(
        "-o", type=str, required=False, default=None, help="Output file. Optional. Default: pred_folder/summary.json"
    )
    parser.add_argument(
        "-np",
        type=int,
...
if __name__ == "__main__":
    ...
    num_processes = 12
    compute_metrics_on_folder(
        folder_ref, folder_pred, output_file, image_reader_writer, file_ending, regions, ignore_label, num_processes
    )
